...
DLL int __stdcall HXPTCLScriptExecute (int SocketIndex, const char * TCLFileName, const char * TaskName, const char * ParametersList);  /* Execute a TCL script from a TCL file */
DLL int __stdcall HXPTCLScriptExecuteAndWait (int SocketIndex, const char * TCLFileName, const char * TaskName, const char * InputParametersList, char * OutputParametersList);  /* Execute a TCL script from a TCL file and wait the end of execution to return */
DLL int __stdcall HXPTCLScriptKill (int SocketIndex, const char * TaskName);  /* Kill TCL Task */
DLL int __stdcall HXPTimerGet (int SocketIndex, const char * TimerName, int * FrequencyTicks);  /* Get a timer */
DLL int __stdcall HXPTimerSet (int SocketIndex, const char * TimerName, int FrequencyTicks);  /* Set a timer */
DLL int __stdcall HXPReboot (int SocketIndex);  /* Reboot the controller */
DLL int __stdcall HXPLogin (int SocketIndex, const char * Name, const char * Password);  /* Log in */
DLL int __stdcall HXPCloseAllOtherSockets (int SocketIndex);  /* Close all socket beside the one used to send this command */
DLL int __stdcall HXPEventAdd (int SocketIndex, const char * PositionerName, const char * EventName, const char * EventParameter, const char * ActionName, const char * ActionParameter1, const char * ActionParameter2, const char * ActionParameter3);  /* ** OBSOLETE ** Add an event */
DLL int __stdcall HXPEventGet (int SocketIndex, const char * PositionerName, char * EventsAndActionsList);  /* ** OBSOLETE ** Read events and actions list */
DLL int __stdcall HXPEventRemove (int SocketIndex, const char * PositionerName, const char * EventName, const char * EventParameter);  /* ** OBSOLETE ** Delete an event */
DLL int __stdcall HXPEventWait (int SocketIndex, const char * PositionerName, const char * EventName, const char * EventParameter);  /* ** OBSOLETE ** Wait an event */
DLL int __stdcall HXPEventExtendedConfigurationTriggerSet (int SocketIndex, int NbElements, const char * ExtendedEventNameList, const char * EventParameter1List, const char * EventParameter2List, const char * EventParameter3List, const char * EventParameter4List);  /* Configure one or several events */
...
DLL int __stdcall HXPEventExtendedConfigurationActionSet (int SocketIndex, int NbElements, const char * ExtendedActionNameList, const char * ActionParameter1List, const char * ActionParameter2List, const char * ActionParameter3List, const char * ActionParameter4List);  /* Configure one or several actions */
...
DLL int __stdcall HXPGatheringConfigurationSet (int SocketIndex, int NbElements, const char * TypeList);  /* Configuration acquisition */
...
DLL int __stdcall HXPGatheringExternalConfigurationSet (int SocketIndex, int NbElements, const char * TypeList);  /* Configuration acquisition */
...
DLL int __stdcall HXPGlobalArraySet (int SocketIndex, int Number, const char * ValueString);  /* Set global array value */
...
DLL int __stdcall HXPGPIOAnalogGet (int SocketIndex, int NbElements, const char * GPIONameList, double AnalogValue[]);  /* Read analog input or analog output for one or few input */
DLL int __stdcall HXPGPIOAnalogSet (int SocketIndex, int NbElements, const char * GPIONameList, double AnalogOutputValue[]);  /* Set analog output for one or few output */
DLL int __stdcall HXPGPIOAnalogGainGet (int SocketIndex, int NbElements, const char * GPIONameList, int AnalogInputGainValue[]);  /* Read analog input gain (1, 2, 4 or 8) for one or few input */
DLL int __stdcall HXPGPIOAnalogGainSet (int SocketIndex, int NbElements, const char * GPIONameList, int AnalogInputGainValue[]);  /* Set analog input gain (1, 2, 4 or 8) for one or few input */
DLL int __stdcall HXPGPIODigitalGet (int SocketIndex, const char * GPIOName, unsigned short * DigitalValue);  /* Read digital output or digital input  */
DLL int __stdcall HXPGPIODigitalSet (int SocketIndex, const char * GPIOName, unsigned short Mask, unsigned short DigitalOutputValue);  /* Set Digital Output for one or few output TTL */
...
DLL int __stdcall HXPPositionerBacklashGet (int SocketIndex, const char * PositionerName, double * BacklashValue, char * BacklaskStatus);  /* Read backlash value and status */
DLL int __stdcall HXPPositionerBacklashSet (int SocketIndex, const char * PositionerName, double BacklashValue);  /* Set backlash value */
DLL int __stdcall HXPPositionerBacklashEnable (int SocketIndex, const char * PositionerName);  /* Enable the backlash */
DLL int __stdcall HXPPositionerBacklashDisable (int SocketIndex, const char * PositionerName);  /* Disable the backlash */
DLL int __stdcall HXPPositionerCorrectorNotchFiltersSet (int SocketIndex, const char * PositionerName, double NotchFrequency1, double NotchBandwith1, double NotchGain1, double NotchFrequency2, double NotchBandwith2, double NotchGain2);  /* Update filters parameters  */
DLL int __stdcall HXPPositionerCorrectorNotchFiltersGet (int SocketIndex, const char * PositionerName, double * NotchFrequency1, double * NotchBandwith1, double * NotchGain1, double * NotchFrequency2, double * NotchBandwith2, double * NotchGain2);  /* Read filters parameters  */
...
DLL int __stdcall HXPPositionerCorrectorPIPositionSet (int SocketIndex, const char * PositionerName, bool ClosedLoopStatus, double KP, double KI, double IntegrationTime);  /* Update corrector parameters */
DLL int __stdcall HXPPositionerCorrectorPIPositionGet (int SocketIndex, const char * PositionerName, bool * ClosedLoopStatus, double * KP, double * KI, double * IntegrationTime);  /* Read corrector parameters */
DLL int __stdcall HXPPositionerCorrectorTypeGet (int SocketIndex, const char * PositionerName, char * CorrectorType);  /* Read corrector type */
DLL int __stdcall HXPPositionerCurrentVelocityAccelerationFiltersSet (int SocketIndex, const char * PositionerName, double CurrentVelocityCutOffFrequency, double CurrentAccelerationCutOffFrequency);  /* Set current velocity and acceleration cut off frequencies */
DLL int __stdcall HXPPositionerCurrentVelocityAccelerationFiltersGet (int SocketIndex, const char * PositionerName, double * CurrentVelocityCutOffFrequency, double * CurrentAccelerationCutOffFrequency);  /* Get current velocity and acceleration cut off frequencies */
DLL int __stdcall HXPPositionerDriverStatusGet (int SocketIndex, const char * PositionerName, int * DriverStatus);  /* Read positioner driver status */
...
DLL int __stdcall HXPPositionerEncoderAmplitudeValuesGet (int SocketIndex, const char * PositionerName, double * CalibrationSinusAmplitude, double * CurrentSinusAmplitude, double * CalibrationCosinusAmplitude, double * CurrentCosinusAmplitude);  /* Read analog interpolated encoder amplitude values */
DLL int __stdcall HXPPositionerEncoderCalibrationParametersGet (int SocketIndex, const char * PositionerName, double * SinusOffset, double * CosinusOffset, double * DifferentialGain, double * PhaseCompensation);  /* Read analog interpolated encoder calibration parameters */
DLL int __stdcall HXPPositionerErrorGet (int SocketIndex, const char * PositionerName, int * ErrorCode);  /* Read and clear positioner error code */
DLL int __stdcall HXPPositionerErrorRead (int SocketIndex, const char * PositionerName, int * ErrorCode);  /* Read only positioner error code without clear it */
...
DLL int __stdcall HXPPositionerHardwareStatusGet (int SocketIndex, const char * PositionerName, int * HardwareStatus);  /* Read positioner hardware status */
...
DLL int __stdcall HXPPositionerHardInterpolatorFactorGet (int SocketIndex, const char * PositionerName, int * InterpolationFactor);  /* Get hard interpolator parameters */
DLL int __stdcall HXPPositionerHardInterpolatorFactorSet (int SocketIndex, const char * PositionerName, int InterpolationFactor);  /* Set hard interpolator parameters */
DLL int __stdcall HXPPositionerMaximumVelocityAndAccelerationGet (int SocketIndex, const char * PositionerName, double * MaximumVelocity, double * MaximumAcceleration);  /* Return maximum velocity and acceleration of the positioner */
DLL int __stdcall HXPPositionerMotionDoneGet (int SocketIndex, const char * PositionerName, double * PositionWindow, double * VelocityWindow, double * CheckingTime, double * MeanPeriod, double * TimeOut);  /* Read motion done parameters */
DLL int __stdcall HXPPositionerMotionDoneSet (int SocketIndex, const char * PositionerName, double PositionWindow, double VelocityWindow, double CheckingTime, double MeanPeriod, double TimeOut);  /* Update motion done parameters */
DLL int __stdcall HXPPositionerSGammaExactVelocityAjustedDisplacementGet (int SocketIndex, const char * PositionerName, double DesiredDisplacement, double * AdjustedDisplacement);  /* Return adjusted displacement to get exact velocity */
DLL int __stdcall HXPPositionerSGammaParametersGet (int SocketIndex, const char * PositionerName, double * Velocity, double * Acceleration, double * MinimumTjerkTime, double * MaximumTjerkTime);  /* Read dynamic parameters for one axe of a group for a future displacement  */
DLL int __stdcall HXPPositionerSGammaParametersSet (int SocketIndex, const char * PositionerName, double Velocity, double Acceleration, double MinimumTjerkTime, double MaximumTjerkTime);  /* Update dynamic parameters for one axe of a group for a future displacement */
DLL int __stdcall HXPPositionerSGammaPreviousMotionTimesGet (int SocketIndex, const char * PositionerName, double * SettingTime, double * SettlingTime);  /* Read SettingTime and SettlingTime */
DLL int __stdcall HXPPositionerStageParameterGet (int SocketIndex, const char * PositionerName, const char * ParameterName, char * ParameterValue);  /* Return the stage parameter */
DLL int __stdcall HXPPositionerStageParameterSet (int SocketIndex, const char * PositionerName, const char * ParameterName, const char * ParameterValue);  /* Save the stage parameter */
DLL int __stdcall HXPPositionerUserTravelLimitsGet (int SocketIndex, const char * PositionerName, double * UserMinimumTarget, double * UserMaximumTarget);  /* Read UserMinimumTarget and UserMaximumTarget */
DLL int __stdcall HXPPositionerUserTravelLimitsSet (int SocketIndex, const char * PositionerName, double UserMinimumTarget, double UserMaximumTarget);  /* Update UserMinimumTarget and UserMaximumTarget */
...
DLL int __stdcall HXPOptionalModuleExecute (int SocketIndex, const char * ModuleFileName, const char * TaskName);  /* Execute an optional module */
DLL int __stdcall HXPOptionalModuleKill (int SocketIndex, const char * TaskName);  /* Kill an optional module */
...
DLL int __stdcall HXPEEPROMCIESet (int SocketIndex, int CardNumber, const char * ReferenceString);  /* Set CIE EEPROM reference string */
...
DLL int __stdcall HXPEEPROMDriverSet (int SocketIndex, int PlugNumber, const char * ReferenceString);  /* Set Driver EEPROM reference string */
DLL int __stdcall HXPEEPROMINTSet (int SocketIndex, int CardNumber, const char * ReferenceString);  /* Set INT EEPROM reference string */
...
DLL int __stdcall HXPTestTCP (int SocketIndex, const char * InputString, char * ReturnString);  /* Test TCP/IP transfert */
